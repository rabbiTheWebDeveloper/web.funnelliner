...
const PendingOrderCustomers = () => {
    const { data, isLoading, isError } = useGetOrdersQuery("pending");
    ...
    // useEffect(() => {
    //     axios
    //         .get(process.env.API_URL + "/client/orders?type=pending", { headers: headers })
    ...
    const handelPdf = () => {
        doc.save('PendingOrderCustomer.pdf');
...
export default PendingOrderCustomers;