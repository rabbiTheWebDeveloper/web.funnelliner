...
const CancelOrderCustomers = () => {
    const {data, isLoading, isError } = useGetOrdersQuery("cancelled");
    ...
    // useEffect(() => {
    //     axios
    //         .get(baseUrl + "/client/orders?type=cancelled", { headers: headers })
...
export default CancelOrderCustomers;
