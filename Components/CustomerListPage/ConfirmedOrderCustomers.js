...
const ConfirmedOrderCustomers = () => {
    const { data, isLoading, isError } = useGetOrdersQuery("confirmed");
    ...
    // useEffect(() => {
    //     axios
    //         .get(process.env.API_URL + "/client/orders?type=confirmed", { headers: headers })
    ...
    const orderCheck = (number) => {
        ...
        return products.filter(product => product.phone === number).length



    }
    // console.log(" orderCheck" ,orderCheck("+8801726245251"))
                                ...
                                {currentProduct?.map((product, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td>{orderCheck(product?.phone)}</td>
                                            <td>
                                                {moment(
                                                    product?.created_at
                                                ).format("DD-MM-YYYY")}
...
export default ConfirmedOrderCustomers;