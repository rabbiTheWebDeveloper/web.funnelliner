...
const ProductReturn = () => {
    ...
    useEffect(() => {
        axios
            .get(process.env.API_URL + "/client/stocks/product-return/list", { headers: headers })
                            ...
                            <div className="Header d_flex d_justify">
                                ...
                                <div className="Left d_flex">
                                    ...
                                    <div className="text">
                                        ...
                                        <p>Return Product List by Courier</p>
                                    </div>
                                ...
                                <table>
                                    ...
                                    {isLoading ? (
                                        ...
                                        currentProduct.length > 0 ? <>
                                            <tbody>
                                                {productSearchValue === "" && currentProduct?.map((product) => {
                                                    return (
                                                        <tr key={product.id}>
                                                ...
                                                {productSearchValue && filterProducts?.map((product) => {
                                                    return (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <img src={product.main_image.name} alt="" />
